...
<p><a href="index.php"><img style="border-radius: 10px;" src="img/salalelogo.jpg" align="left" width="150px" height="120px"></a>
<img style="border-radius:55px;box-shadow:1px 1px 12px black" src="img/salalelogo.jpg" align="center" width="410px" height="120px"></p>
</td>
</tr>
<!--End Of Header-->
<!--Main menus-->
...
<tr>
<td><br><br><center><img src="img/img1.jpg" width="200px" height="150px"></center></td>
</tr>
</table>
<br>
<br>
...
<tr>
<td><img src="img/Picture2.png" width="10px">&nbsp;<a href="http://www.Su.edu.et">SU Site</a></td>
</tr>
<tr>
<td><img src="img/Picture2.png" width="10px">&nbsp;<a href="site.php">Site Map</a></td>
</tr>
<tr>
<td><img src="img/Picture2.png" width="10px">&nbsp;<a href="https://mail.google.com/a/Su/edu.et">Web Mail</a></td>
</tr>
</table>
<br>
<br>
...
<p style="font-size:14px;color:blue;" >Your Dormitory Placement information is launched.You can see Your Dormitory Placement  information by entering your id or registration number.</p>
  ...
  <tr>
	       ...
	       <td class='para1_text' width="220px"><font color="red">*</font> Student ID No.</td><td>
			<input type="text" name="idno" required x-moz-errormessage="Enter Your ID No." ></td>
...
if (isset($_POST['submitlogin'])){ 
    $idno = $_POST['idno'];
    // Assuming $conn is your mysqli connection from connection.php
